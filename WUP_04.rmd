...
ChatGPT will be used for most of the construction of the code-blocks that analyze the data in this report, including both the descriptive and inferential results to examine if WORDSUM score is affected by education level. 
...
There is a notable trend in the average wordsum score that scales upward as education level increases. However despite the small p-value and this trend in data there is little to support that there is a statistically significant difference between the data groups with the exception of 
